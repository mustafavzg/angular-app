	...
	function($scope, Users, _) {
		...
		$scope.$watchCollection('filteredUsers', function (newUsers, oldUsers) {
			...
			if( !angular.equals(newUsers, oldUsers) ){
				...
				// $scope.fooTeamMembers = $scope.getUsers($scope.project.teamMembers);

				// $scope.fooTeamMembers = $scope.getUsers(newUserIds);
		...
		$scope.$watchCollection('project.teamMembers', function (newUserIds, oldUserIds) {
